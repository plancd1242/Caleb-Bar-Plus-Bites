/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: e114a3409f003525f280de1b2f0afb8a)
// Runtime types generated with workerd@1.20260907.1 2026-09-07 nodejs_compat
interface __BaseEnv_Env {
	ASSETS: Fetcher;
	RESTAURANT_ID: "caleb-main";
	RESTAURANT: DurableObjectNamespace<import("./worker/index").Restaurant>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./worker/index");
		durableNamespaces: "Restaurant";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "RESTAURANT_ID">> {}
}
